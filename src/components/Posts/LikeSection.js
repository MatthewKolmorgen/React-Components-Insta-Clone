// X Look at the number of likes on line 26. Right now it's hard coded to '100'.
// X Use a piece of data coming in through props to display the correct number of likes.
// X You will also add an onClick handler that utilizes `likePost` to increase the count of likes.
...
const LikeSection = props => {
  // 🔥 X Make sure the parent of LikeSection is passing the right props!
